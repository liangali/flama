...
int main4(int argc, char** argv) {
    Params cliParams = {};
    FILE* source = NULL;
    const std::string modelPath = "D:\\models\\Qwen2.5-VL-3B-Instruct-int4-opt\\";
    const char* videofile = "D:\\workspace\\VLMService_GPU\\demo\\bbb_sunflower_2160p_60fps_normal.mp4";
    ...
    //}
    {
       ...
       // cliParams.infileName = "D:\workspace\VLMService_GPU\demo\bbb_sunflower_2160p_60fps_normal.mp4";
       // cliParams.inmodelName = "D:\\models\\Qwen2.5-VL-3B-Instruct-int4-opt\\";
        cliParams.impl = MFX_IMPL_HARDWARE;
    }
    try {
        //-- Open input h265 stream
        fopen_s(&source, /*cliParams.infileName*/videofile, "rb");
        ...
        //-- Create session
        session = CreateVPLSession(&loader, &cliParams);  // MFX_IMPL_HARDWARE
